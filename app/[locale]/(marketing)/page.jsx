    ...
    <>
      ...
      <section className="section-padding bg-background">
        <div className="container-narrow text-center">
          <FadeIn>
            <p className="subtitle mb-6">{t('philosophy.subtitle')}</p>
          </FadeIn>
          <FadeIn delay={100}>
            <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl mb-8 text-balance">
              {t('philosophy.title')}
              <br />
              <span className="text-gold italic">{t('philosophy.titleHighlight')}</span>
            </h2>
          </FadeIn>
          <FadeIn delay={200}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
            ...
            <FadeIn delay={0}>
              <div className="text-center group">
                ...
                <h3 className="font-serif text-xl mb-3">{t('pillars.products.title')}</h3>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  {t('pillars.products.description')}
                </p>
              </div>
            </FadeIn>
            ...
            <FadeIn delay={150}>
              <div className="text-center group">
                ...
                <h3 className="font-serif text-xl mb-3">{t('pillars.cuisine.title')}</h3>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  {t('pillars.cuisine.description')}
                </p>
              </div>
            </FadeIn>
            ...
            <FadeIn delay={300}>
              <div className="text-center group">
                ...
                <h3 className="font-serif text-xl mb-3">{t('pillars.service.title')}</h3>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  {t('pillars.service.description')}
                </p>
              </div>
            </FadeIn>
          </div>
        ...
        <div className="container-narrow text-center">
          ...
          <FadeIn delay={100}>
            <h2 className="font-serif text-3xl sm:text-4xl mb-6">
              {t('cellar.title')} <span className="text-gold italic">{t('cellar.titleHighlight')}</span>
            </h2>
          </FadeIn>
          <FadeIn delay={200}>
            <div className="separator-gold mx-auto mb-8" />
        ...
        <div className="relative container-narrow text-center">
          ...
          <FadeIn delay={100}>
            <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl text-blanc mb-6 text-balance">
              {t('cta.title')}
              <br />
              <span className="italic">{t('cta.titleHighlight')}</span>
            </h2>
          </FadeIn>
          <FadeIn delay={200}>
